...
for the SVM, also for each kfold generates csv file with features ID of the selected features sorted by importance rank. """
...
def do_RFECV(data, labels, random_state):
    ...
    for train_index, test_index in kf.split(X_data):
        ...
        print("Number of features after elimination: %f [Acc: %.1f]" % (
        rfecv.n_features_, rfecv.grid_scores_[rfecv.n_features_]))
